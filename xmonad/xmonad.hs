...
-- tray bar
myTrayBar = "killall -9 trayer; trayer --edge top --align right --SetDockType true --SetPartialStrut true --expand true --width 5 --height 22 --transparent true --tint 0x000000"
